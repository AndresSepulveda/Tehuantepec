...
%
CROCO_title  = 'GT Model';
CROCO_config = 'Mauro_GT';
%
% Grid dimensions:
%
%%lonmin = -100;   % Minimum longitude [degree east]
%%lonmax = -90;   % Maximum longitude [degree east]
%%latmin = 10;   % Minimum latitudeF  [degree north]
%%latmax = 17;   % Maximum latitude  [degree north]
%
...
latmin = 4;   % Minimum latitude  [degree north]
latmax = 18;   % Maximum latitude  [degree north]
%
% Grid resolution [degree]
%
dl = 1/12;  % 9km 659x171
...
%
CROCOTOOLS_dir = '/data2/matlab/CROCOv1p2p1/croco_tools/';
%CROCOTOOLS_dir = [getenv('tools') '/'];
%
%  Run directory
%
RUN_dir='/data1/matlab/Tehuantepec/';
%
...
%-----------------------
%
OGCM        = 'mercator';        % Select the OGCM: SODA, ECCO
%
...
if strcmp(OGCM,'mercator')
  user     = 'asepulveda';
  password = 'And2cmems';
  pathMotu ='/data2/matlab/CROCOv1p2p1/croco_tools/Forecast_tools/';
  mercator_type=3;   % 1 -->  1/12 deg Mercator forecast
                     % 2 -->  1/4  deg Met-Office forecast (GloSea5)
                     % 3 -->  1/12  Mercator Reanalysis  GLORYS12V1 (1993-
                     % 4 
  if mercator_type==1
  ...
  elseif mercator_type==3
      motu_url_fcst='http://my.cmems-du.eu/motu-web/Motu';
      service_id_fcst='GLOBAL_MULTIYEAR_PHY_001_030-TDS';
      product_id_fcst='cmems_mod_glo_phy_my_0.083_P1D-m'
  end
end
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
